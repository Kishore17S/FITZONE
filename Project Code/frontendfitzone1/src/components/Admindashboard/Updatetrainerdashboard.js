...
import { HEADER, gettrainerById } from '../../Service/Api';
...
function Updatetrainerdashboard() {
    ...
    async function fetchtrainerbyid() {

        try{
            console.log("IN");
            await gettrainerById(localStorage.getItem("trainerID")).then((res)=>{
    ...
    const handlesaveupdate =async (e) => {
        ...
        try{
          ...
          const response=await axios.put(`http://localhost:8080/trainer/trainerput/${fields.trainerid}`,{
  ...
  return (
    <div className='bg'>
   <div className='back2'>
     <h2 className='header2'>Update Trainer</h2>
       ...
       {/*<div className='dp_userid2'>
               ...
               <div className='dp_name'>
                 ...
                 <input className='Userdatainput2'
                   ...
                   id="username"
                   name="username"
                   onChange={(e)=>{setTrainername(e.target.value)}} defaultValue={fields.trainername}
               ...
               <div className='dp_gender2'>
                 ...
                 <input className='Userdatainput2'
                   ...
                   id="gender"
                   name="gender"
                   onChange={(e)=>{setEmail(e.target.value)}} defaultValue={fields.email}
               ...
               <div className='dp_height2'>
                 ...
                 <input className='Userdatainput2'
                   ...
                   id="height"
                   name="height"
                   onChange={(e)=>{setPhonenum(e.target.value)}} defaultValue={fields.phonenumber}
               ...
               <div className='dp_age2'>
                 ...
                 <input className='Userdatainput2'
                   ...
                   id="age"
                   name="age"
                   onChange={(e)=>{setAge(e.target.value)}} defaultValue={fields.age}
               ...
               <div className='dp_weight2'>
                 ...
                 <input className='Userdatainput2'
                   ...
                   id="weight"
                   name="weight"
                   onChange={(e)=>{setExperience(e.target.value)}} defaultValue={fields.experience}
...
export default Updatetrainerdashboard
